  ...
  return (
    <>
      ...
      <div className= "social"> 
        <Link href="https://www.instagram.com/jessc.miller/"><a><Image src='/instagram.ico'  height={22.5} width={22.5}/></a></Link>  <Link href="https://www.twitter.com/jessicacmiller_"><a><Image src='/twitter.ico'  height={22.5} width={22.5}/></a></Link> <Link href="https://www.linkedin.com/in/jessica-cmiller/"><a><Image src='/linkedin.ico'  height={22.5} width={22.5}/></a></Link>
      </div>  
    </>
  );
}
